...
interface VaultLogsSidebarProps {
  vaultAddress: string | null;
  isOpen: boolean;
  onClose: () => void;
}

export const VaultLogsSidebar: React.FC<VaultLogsSidebarProps> = ({
  vaultAddress,
  isOpen,
  onClose,
}) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className="fixed top-0 left-0 h-full w-96 bg-background border-r shadow-lg z-50 flex flex-col">
        {/* Header */}
