    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      <Card className="border shadow-sm hover:shadow-md transition-shadow">
        <CardContent className="px-6 py-6 space-y-4">
          ...
          <CardDescription className="mb-3">See what you can borrow</CardDescription>
      ...
      <Card className="border shadow-sm hover:shadow-md transition-shadow">
        <CardContent className="px-6 py-6 space-y-4">
          ...
          <CardDescription className="mb-3">Start your loan process</CardDescription>
      ...
      <Card className="border shadow-sm hover:shadow-md transition-shadow">
        <CardContent className="px-6 py-6 space-y-4">
          ...
          <CardDescription className="mb-3">Real customer experiences</CardDescription>
          <div className="flex items-center gap-2">
